package sandbox9.thunderbolt.event.sync;
...
import static sandbox9.thunderbolt.message.product.ProductEventKey.PRICE;
import static sandbox9.thunderbolt.message.product.ProductEventKey.STOCK;
...
public class ProductUpdateJob {
    ...
    public void updateProduct() {
        ...
        updateProductByEvent(info, PRICE);
        updateProductByEvent(info, STOCK);
    ...
    private void updateProductByEvent(ExecutionInfo info, ProductEventKey eventKey) {
        ...
        List<ProductSkuPriceEvent> eventList =
                (List<ProductSkuPriceEvent>) eventRepository.findEvent(eventKey);
