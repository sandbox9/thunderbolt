package sandbox9.thunderbolt.api.product;
...
public class ProductUpdateJob {
    ...
    @Autowired
    private ProductEventMongoRepository eventRepository;
        ...
        for (ProductEvent event : eventList) {
            try {
                ...
                CatalogProduct catalogProduct =
                        catalogProductCustomRepository.find(event.getProductId(), event.getSkuId());
